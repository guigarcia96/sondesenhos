...
public class DesenhosAdapter extends ArrayAdapter<ParseObject> {
    ...
    public DesenhosAdapter(@NonNull Context c, @NonNull ArrayList<ParseObject> objects) {
        super(c, 0, objects);
        this.context = c;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View view = convertView;
            ...
            if (view == null){
                ...
                view = inflater.inflate(R.layout.layout_desenho, parent, false);

        }
            if (nomesSons.size() >= 1)
            {
                ImageView imagemPostagem = (ImageView) view.findViewById(R.id.listview_image);
                TextView txtNomeDesenho = (TextView)view.findViewById(R.id.listview_item_title);
